    ...
    return (
        <div className="container mx-auto px-4 my-[60px]">
            <div className="flex justify-between gap-4 items-center">
                {selectedType === "available" ? <h2 className="px-8 text-3xl font-bold">Available Players</h2> : <h2 className="px-8 text-3xl font-bold">Selected Players ({selectedPlayers.length}/{player.length})</h2>}
                <div className="px-6 ">
